  ...
  exports.runSDFTest = () => {
    ...
    const main = async() => {
      ...
      try {
        ...
        const docorig = await PDFNet.PDFDoc.createFromFilePath(inputURL + 'fish.pdf');
        ...
        await doc.save('../../TestFiles/Output/sdftest_out.pdf', 0, '%PDF-1.4'); // PDFNet.SDFDoc.SaveOptions.e_remove_unused
        console.log('Done.');
      } catch (err) {
        console.log(err);
      }
