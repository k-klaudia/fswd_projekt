...
((exports) => {
  ...
  exports.runPageLabelsTest = () => {
    const main = async () => {
      ...
      const output_file = output_path + "newsletter_with_pagelabels.pdf";
      ...
      try {
        ...
        //-----------------------------------------------------------
        {
          ...
          doc.save(output_file, PDFNet.SDFDoc.SaveOptions.e_linearized);
        ...
        //-----------------------------------------------------------
        {
          ...
          doc.save(output_path + "newsletter_with_pagelabels_modified.pdf", PDFNet.SDFDoc.SaveOptions.e_linearized);
