  ...
  exports.runPDFA = () => {
    ...
    const main = async() => {
      try {
        ...
        const pdfa = await PDFNet.PDFACompliance.createFromFile(convert, url, pwd, PDFNet.PDFACompliance.Conformance.e_Level1B, exceptions, maxRefObjs, firstStop);
      ...
      try {
        ...
        const pdfa = await PDFNet.PDFACompliance.createFromFile(convert, urlInput, pwd, PDFNet.PDFACompliance.Conformance.e_Level1B, exceptions, maxRefObjs);
        ...
        await pdfa.saveAsFromFileName('../../TestFiles/Output/' + outputFilename, linearize);
